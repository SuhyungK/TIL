...
- [함수의 입력](https://github.com/SuhyungK/TIL/blob/master/Python/04_%ED%95%A8%EC%88%98.md#%ED%95%A8%EC%88%98%EC%9D%98-%EC%9E%85%EB%A0%A5ㅌ)
...
- 기본값이 Positional Argument이기 때문에 `add(2, y=5)` x = 2, y = 5 : positional → keyword *ERROR 안 남*
